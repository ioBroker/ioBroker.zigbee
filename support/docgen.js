...
const deviceMapping = require(__dirname + '/lib/devstates').devices;
const fs = require('fs');
...
const logDevices = (devices) => {
    ...
    devices.forEach((device) => {
        const pathFriendly = device.models.replace(new RegExp("/", "g"), '-').replace(new RegExp(":", "g"), '-').replace(new RegExp(" ", "g"), '-');
        result += `| ${device.models} |  (${device.states}) | ![${pathFriendly}](${device.icon}) |\n`;
    });
