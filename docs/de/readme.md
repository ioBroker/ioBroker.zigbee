...
10.	Prüfen ob der Adapter in ioBroker grün wird. Das kann bis zu 60 Sekunden dauern. Sollzustand: <br> ![](img/Bild10.png) <br> Andernfalls die Meldungen im ioBroker Log lesen. Diese beinhalten Informationen darüber warum der Adapter nicht gestartet wurde. und Fehlerursache suchen, im Forum stehen viele Lösungsansätze.
