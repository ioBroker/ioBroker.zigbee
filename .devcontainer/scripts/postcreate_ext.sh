...
iob object set system.adapter.zigbee.0 native.adapterType=zstack
...
iob object set system.adapter.zigbee.0 native.debugHerdsman=false
iob object set system.adapter.zigbee.0 native.autostart=false
