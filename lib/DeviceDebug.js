...
class DeviceDebug extends EventEmitter {
    ...
    onDebugEvent(message) {
        if (typeof message === 'object' && message.hasOwnProperty('ID') && message.hasOwnProperty('data')) {
            ...
            if (data.states) for (const state of data.states) item.states.push(state);
