    ...
    async start() {
        try {
           ...
           // debug info from herdsman getNetworkParameters
            ...
            let extendedPanIDDebug = debNetworkParam.extendedPanID.replace('0x','');
            extendedPanIDDebug = extendedPanIDDebug.split('').reverse().join('');
            this.debug(`Zigbee network parameters: panID=${debNetworkParam.panID} channel=${debNetworkParam.channel} extendedPanID=${extendedPanIDDebug}`);
