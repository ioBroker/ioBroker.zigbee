        ...
        switch (expose.type) {
            ...
            case 'numeric':
                if (expose.endpoint) {
                    ...
                    switch (expose.name) {
                        ...
                        case 'voltage':
                            state = modifyState(genState(expose, 'level.battery'), {
                                icon:'img/battery_v.png',
                                name:'Reported battery voltage',
            ...
            case 'binary':
                if (expose.endpoint) {
                    ...
                    switch (expose.name) {
                        case 'contact':
                            state = genState(expose, 'sensor');
                            // state = getStateDefinition('contact');
                            pushToStates(modifyState(state, {
                                id:'opened',
                                name:'is open',
                                role:'sensor.contact',
