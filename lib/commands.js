                ...
                switch (obj.command) {
                    ...
                    case 'getUploadRequired':
                        if (obj) {
                            ...
                            */
                            this.adapter.sendTo(obj.from, obj.command, {upload: filesToUpload.length != uploadedFiles.length, clean:this.stController.CleanupRequired()}, obj.callback);
                        }
                }
            }
        }
