                ...
                .then((result) => {
                    ...
                    result.forEach((devInfo) => {
                        if (devInfo._id) {
                            ...
                            chain.push((res) => {
                                return this.adapter.getStatesOfAsync(devInfo._id)
                                    .then((states) => {
                                        ...
                                        devInfo.statesDef = (states || []).filter((stateDef)=>{
                                            ...
                                            return {
                                                ...
                                                val: (devInfo.states[stateDef._id]) ? devInfo.states[stateDef._id].val : undefined,
                                                role: stateDef.common.role,
                                            };
                                        });
                                        delete devInfo.states;
                                        return res;
                                    });
                            });
                        }
