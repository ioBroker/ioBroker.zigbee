                ...
                if (device.mapped.options && typeof (device.mapped.options == 'object')) {
                    ...
                    for (const option of device.mapped.options) {
                        if (option.name) {
                            ...
                            ////// Here: check if a model is in the global overrides, else dont push into the modelSetOptions
                            rv.mapped.modelSetOptions.push({key: option.name, value: undefined });
                        }
                    }
                }
            }
