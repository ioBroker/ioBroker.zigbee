...
class Commands {
    ...
    buildDeviceInfo(entity) {
        ...
        try {
            ...
            if (entity.mapped) {
                ...
                const arr = (typeof entity?.mapped?.exposes === 'function') ? entity.mapped.exposes(entity.device) : (entity?.mapped?.exposes || []);
                rv.mapped.readKeys = arr?.find((e) => e.type == 'light') != undefined;
    ...
    async getDevices(from, command, id, callback) {
        ...
        const rv = { devices:deviceObjects,
