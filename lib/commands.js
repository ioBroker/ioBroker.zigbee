                ...
                try
                {
                    ...
                    if (coordinatorVersion && coordinatorVersion.type && coordinatorVersion.meta) {
                        ...
                        if (meta) {
                            ...
                            vt = vt.concat(meta.hasOwnProperty('product') ? meta.product.toString() + '.': 'x.');
                            vt = vt.concat(meta.hasOwnProperty('majorrel') ? meta.majorrel.toString() + '.': 'x.');
                            vt = vt.concat(meta.hasOwnProperty('minorrel') ? meta.minorrel.toString() + '.': 'x.');
                            vt = vt.concat(meta.hasOwnProperty('maintrel') ? meta.maintrel.toString() + '.': 'x.');
