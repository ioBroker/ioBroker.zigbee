    ...
    */
    ...
    async addBinding(from, command, params, callback) {
        try {
            ...
            await this.doBindUnbind('bind', params.s_address, params.s_ep, params.clusters.length > 0 ? params.cluster : ['all'], params.b_address, params.b_ep, params.allowAllClusters,
                (err) => {
