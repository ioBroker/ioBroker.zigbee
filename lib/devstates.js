...
const states = {
   ...
   smoke_detected2: {   // for Heiman
    ...
    hvacThermostat_unoccupied_heating_setpoint: {
        id: 'unoccupied_heating_setpoint',
    ...
    hvacThermostat_pi_running_demand: {
        id: 'pi_heating_demand',
    ...
    // Eurotronics Spirit Zigbee specific states
    SPZB0001_running_demand: {
        id: 'heating_demand',
        prop: 'pi_heating_demand',
        name: 'Valve position',
        icon: undefined,
    ...
    SPZB0001_heating_setpoint_16387: {
        id: 'heating_setpoint_1',
        prop: 'current_heating_setpoint',
        name: 'Target Temperature 1',
        icon: undefined,
        role: 'value.temperature',
        write: true,
        read: true,
    ...
    SPZB0001_system_status: {
        id: 'system_status',
        name: 'System Status',
        prop: 'eurotronic_16386',
        icon: undefined,
        role: 'state',
        write: false,
        read: true,
    ...
    SPZB0001_system_status_message: {
        ...
        type: 'string',
        getter: payload => {
            if (payload.eurotronic_16386) {
                var errnum = payload.eurotronic_16386 & 0x38;
                if (errnum === 0) return 'OK';
                var errstring = 'ERROR';
                if (errnum & 0x08 === 0x08) errstring = errstring + ' E1';
                if (errnum & 0x20 === 0x10) errstring = errstring + ' E2';
...
const devices = [{
    ...
    // Eurotronics
    {
        ...
        states: [states.battery,
                ...
                states.SPZB0001_heating_setpoint,states.SPZB0001_heating_setpoint_16387,states.SPZB0001_system_mode,
                states.SPZB0001_system_status,states.SPZB0001_system_status_message, states.SPZB0001_running_demand],
    },
    // Immax
    {
        vendor: 'Immax',
