...
// osram switch
   long_middle: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'long_middle') ? true : (payload.action === 'long_middle') ? false : undefined,
    },
...
const devices = [{
                 ...
                 
    {
        ...
        states: [states.rwl_state, states.long_middle, states.battery],
    },                 
    ...
    // Bitron
    {
        ...
        states: [states.state, states.power],
    },
