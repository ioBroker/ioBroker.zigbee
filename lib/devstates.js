...
//        type: 'number',
    ...
    aqara_opple_color_up: {
        id: 'btn_color_up',
        prop: 'action',
        name: 'Color up click event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'color_up') ? true : undefined,
        isEvent: true,
    },
    aqara_opple_color_down: {
        id: 'btn_color_down',
        prop: 'action',
        name: 'Color down click event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'color_down') ? true : undefined,
        isEvent: true,
    },
};
...
const devices = [{
    ...
    },
    {
        ...
        states: [
            states.aqara_opple_on, states.aqara_opple_off,
            states.aqara_opple_up, states.aqara_opple_down,
        ],
    },
    {
        vendor: 'Xiaomi',
        ...
        states: [
            states.aqara_opple_on, states.aqara_opple_off,
            states.aqara_opple_up, states.aqara_opple_down,
            states.aqara_opple_color_up, states.aqara_opple_color_down,
        ],
    },
