...
// osram switch mini
   switch_circle: {
    ...
    E1743_brightness: {
        ...
        read: true,
        type: 'string',
//        getter: payload =>  (typeof(payload.action) === "string") ? (payload.action === 'brightness_up' ? 'up' : (payload.action payload.action.startsWith('brightness') ? payload.action.substr(11) : undefined)) : undefined,
        getter: payload => {
            if (typeof(payload.action) === "string") {
              if (payload.action.startsWith('brightness')) return payload.action.substr(11);
                return Math.round(payload.brightness*100/254);
            }
            return undefined
        },
...
*/
    ...
    },
    {
        ...
        icon: 'img/Ikea.OnOffSwitch.png',
        states: [states.E1743_brightness,states.genOnOff, states.battery
        ],
    },
    {
        vendor: 'IKEA',
