...
const devices = [{
        ...
        states: [states.click, states.double_click, states.triple_click, states.quad_click,
            states.many_click, states.long_click, states.voltage, states.battery, states.battery_sec
        ],
    },
    {
        vendor: 'Xiaomi',
        ...
        states: [states.click, states.double_click, states.triple_click, states.quad_click,
            states.voltage, states.battery, states.battery_sec
        ],
    },
    {
        vendor: 'Xiaomi',
        ...
        states: [states.click, states.double_click, states.voltage, states.battery, states.battery_sec,
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_86sw1\u0000lu', 'lumi.remote.b186acn01\u0000\u0000\u0000'],
        icon: 'img/86sw1.png',
        states: [states.click, states.voltage, states.battery, states.battery_sec,
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_86sw2\u0000Un', 'lumi.sensor_86sw2.es1', 'lumi.remote.b286acn01\u0000\u0000\u0000'],
        icon: 'img/86sw2.png',
        states: [states.left_click, states.right_click, states.both_click, states.voltage, states.battery, states.battery_sec],
    },
    {
        vendor: 'Xiaomi',
    ...
    },
    {
        ...
        states: [states.temperature, states.humidity, states.voltage, states.battery, states.battery_sec],
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.weather'],
        icon: 'img/aqara_temperature_sensor.png',
        states: [states.temperature, states.humidity, states.pressure, states.voltage, states.battery, states.battery_sec],
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_motion'],
        icon: 'img/aqara_numan_body_sensor.png',
        states: [states.occupancy, states.no_motion, states.voltage, states.battery, states.battery_sec, states.occupancy_timeout],
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_motion.aq2'],
        icon: 'img/aqara_numan_body_sensor.png',
        states: [states.occupancy, states.no_motion, states.illuminance, states.voltage, states.battery, states.battery_sec, states.occupancy_timeout],
    },
    {
        vendor: 'Xiaomi',
        models: ['lumi.sensor_magnet'],
        icon: 'img/magnet.png',
        states: [states.contact, states.isopen, states.voltage, states.battery, states.battery_sec],
    },
    {
        vendor: 'Xiaomi',
    ...
    },
    {
        ...
        states: [states.water_detected, states.voltage, states.battery, states.battery_sec],
    },
    {
        vendor: 'Xiaomi',
        ...
        states: [states.shake, states.wakeup, states.fall, states.tap, states.slide, states.flip180,
            ...
            states.rotate_angle, states.battery_sec
        ],
    },
    {
        vendor: 'Xiaomi',
    ...
    },
    {
        ...
        icon: 'img/smoke.png',
        states: [states.smoke_detected, states.voltage, states.battery, states.battery_sec],
    },
    ...
    {
        vendor: 'OSRAM',
        models: ['Flex RGBW', 'LIGHTIFY Indoor Flex RGBW', 'Gardenpole RGBW-Lightify'],
    ...
    },
    {
        ...
        states: [states.rwl_state, states.rwl_up_button, states.rwl_down_button, states.battery, states.battery_sec],
