...
const states = {
 ...
 //    },
    ...
    vibration_action: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'vibration'),
    },
    tilt_action: {
        id: 'tilt',
        prop: 'action',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'tilt'),
    },
    drop_action: {
        id: 'drop',
        prop: 'action',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'drop'),
    },
    vibration_angle: {
        id: 'angle',
        prop: 'angle',
        name: 'Vibration angle',
        icon: undefined,
        role: 'state',
        write: false,
        read: true,
    ...
    vibration_angle_x_abs: {
        id: 'angle_x_abs',
        prop: 'angle_x_absolute',
        name: 'Vibration angle X absolute ',
        icon: undefined,
        role: 'state',
        write: false,
        read: true,
    ...
    vibration_angle_y_abs: {
        id: 'angle_y_abs',
        prop: 'angle_y_absolute',
        name: 'Vibration angle Y absolute',
        icon: undefined,
        role: 'state',
        write: false,
        read: true,
...
const devices = [{
    ...
    },
    {
        ...
        states: [states.battery, states.vibration_action, states.tilt_action, states.drop_action,
            states.vibration_angle, states.vibration_angle_x, states.vibration_angle_y, states.vibration_angle_z,
            states.vibration_angle_x_abs, states.vibration_angle_y_abs,
        ],
    },
