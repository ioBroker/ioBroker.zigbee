 ...
 //    },
   ...
   smoke_detected2: {   // for Heiman
    ...
    E1524_left_hold: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'arrow_left_hold') ? true : undefined,
    },
    E1524_right_hold: {
        id: 'right_hold',
        prop: 'action',
        name: 'Right hold event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'arrow_right_hold') ? true : undefined,
    },
    E1524_left_release: {
        id: 'left_release',
        prop: 'action',
        name: 'Left release event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'arrow_left_release') ? true : undefined,
    },
    E1524_right_release: {
        id: 'right_release',
        prop: 'action',
        name: 'Right release event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'arrow_right_release') ? true : undefined,
    },
    ...
    E1524_up_hold: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'brightness_up_hold') ? true : undefined,
    },
    E1524_down_hold: {
        id: 'down_hold',
        prop: 'action',
        name: 'Down hold event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'brightness_down_hold') ? true : undefined,
    },
    E1524_up_release: {
        id: 'up_release',
        prop: 'action',
        name: 'Up release event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'brightness_up_release') ? true : undefined,
    },
    E1524_down_release: {
        id: 'down_release',
        prop: 'action',
        name: 'Down release event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'brightness_down_release') ? true : undefined,
    },
};
...
const devices = [{
    ...
    },
    {
        ...
        icon: 'img/tradfri_wireless_dimmer.png',
        states: [states.brightness, states.battery],
    },
    {
        vendor: 'IKEA',
        ...
        states: [states.E1524_toggle, 
            ...
            states.E1524_left_hold, states.E1524_right_hold, states.E1524_up_hold, states.E1524_down_hold,
            states.E1524_left_release, states.E1524_right_release, states.E1524_up_release, states.E1524_down_release,
        ],
    },
