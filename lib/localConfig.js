...
class localConfig extends EventEmitter {
    ...
    static DefaultModelOptions = {
        models: {
            ...
            'CK-BL702-AL-01': [{key:'meta_message', value:'brightness'}],
            'CK-BL702-AL-01(7008_Z102LG01-1)': [{key:'meta_message', value:'brightness'}],
        },
        options: {
    ...
    optionExists(option) {
        ...
        if (this.checkForOption(this.localData.by_device, option)) return true;
        return false;
    }
