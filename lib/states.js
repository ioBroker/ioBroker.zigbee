...
// osram switch mini
   switch_circle: {
    ...
    E1744_skip_step_size: {
        ...
        read: true,
        type: 'number',
        getter: payload => (payload.action === 'skip_backward' || payload.action === 'skip_forward') ? payload.step_size : undefined,
    },
    E1744_skip_transition_time: {
        ...
        read: true,
        type: 'number',
        getter: payload => (payload.action === 'skip_backward' || payload.action === 'skip_forward') ? payload.transition_time : undefined,
    },
