...
*/
    ...
    switch_circleclick: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'circle_click') ? true : undefined,
    },
    switch_circlehold: {
        id: 'circle_hold',
        prop: 'action',
        name: 'circlehold toggle event',
        icon: undefined,
        role: 'switch',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'circle_hold') ? true : undefined,
    },
    switch_down: {
        id: 'down',
        prop: 'action',
        name: 'downclick toggle event',
        icon: undefined,
        role: 'switch',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'down') ? true : undefined,
    },
    switch_downhold: {
        id: 'down_hold',
        prop: 'action',
        name: 'downhold toggle event',
        icon: undefined,
        role: 'switch',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'down_hold') ? true : undefined,
    },
    switch_up: {
        id: 'up',
        prop: 'action',
        name: 'upclick toggle event',
        icon: undefined,
        role: 'switch',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'up') ? true : undefined,
    },
    switch_uphold: {
        id: 'up_hold',
        prop: 'action',
        name: 'uphold toggle event',
        icon: undefined,
        role: 'switch',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'up_hold') ? true : undefined,
    },
    // new RWL states
    rwl_state: {
        id: 'state',
