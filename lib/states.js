...
const states = {
    ...
    moes_trv_program_mode: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.preset_mode === 'program'),
        setattr: 'preset',
        setter: (value) => (value) ? 'program' : 'hold',
    },
    moes_trv_manual_mode: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.preset_mode === 'hold'),
        setattr: 'preset',
        setter: (value) => (value) ? 'hold' : 'program',
    },
    moes_trv_heating: {
        id: 'heating',
        name: 'Heating',
    ...
    moes_trv_sensor: {
        id: 'sensor',
        name: 'Sensor (IN/AL/OU)',
        prop: 'sensor',
        icon: undefined,
        role: 'state',
        write: true,
        read: true,
        type: 'string', // valid: IN, AL, OUT
