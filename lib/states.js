...
const states = {
    ...
    white_state: {
        ...
        setter: (value) => (value) ? 'ON' : 'OFF',
        setterOpt: (value, options) => {
            return {...options, state: {white_value: 0}};
        },
        inOptions: true,
    },
    white_colortemp: {
    ...
    ts0043_middle_click: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_single') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_click: {
    ...
    ts0043_middle_double: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_double') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_double: {
    ...
    ts0043_middle_hold: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_hold') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_hold: {
        id: 'button_left_hold',
    ...
    alarm: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.alarm === 'ON') ? true : false,
        setter: (value) => (value) ? 'ON' : 'OFF',
    },
    melody: {
        id: 'melody',
    ...
    temperature_alarm: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.temperature_alarm === 'ON') ? true : false,
        setter: (value) => (value) ? 'ON' : 'OFF',
    },
    humidity_alarm: {
        id: 'humidity_alarm',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.humidity_alarm === 'ON') ? true : false,
        setter: (value) => (value) ? 'ON' : 'OFF',
    },
    l1_state: {
        id: 'l1_state',
    ...
    button7_single: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'button_7_single') ? true : undefined,
    },
    button8_single: {
        id: 'btn8_single',
        prop: 'action',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'button_8_single') ? true : undefined,
    },
    button1_double: {
        id: 'btn1_double',
        prop: 'action',
    ...
    button7_double: {
        id: 'btn7_double',
        prop: 'action',
        name: 'Button 7 double click event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'button_7_double') ? true : undefined,
    },
    button8_double: {
        id: 'btn8_double',
        prop: 'action',
        name: 'Button 8 double click event',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'button_8_double') ? true : undefined,
    },
    button1_hold: {
        id: 'btn1_hold',
        prop: 'action',
    ...
    button7_hold: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'button_7_hold') ? true : (payload.action === 'button_7_release') ? false : undefined,
    },
    button8_hold: {
        id: 'btn8_hold',
        prop: 'action',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'button_8_hold') ? true : (payload.action === 'button_8_release') ? false : undefined,
    },
/*    
    gira_pressed_up: {
        id: 'action',
