...
const states = {
   ...
   right_click_long: {
    ...
    rotate_stop: {
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === 'stop') ? true : undefined,
    },
    rotate_angle: {
        id: 'rotate_angle',
        prop: 'angle',
...
// osram switch mini
   switch_circle: {
    ...
    button_action_off: {
      // generic on button with 'action=off' as payload
      id: 'button_off',
      prop: 'action',
      name: 'Button Off',
      icon: undefined,
    ...
    button_action_skip_forward: {
      // generic on button with 'action=skip_forward' as payload
    ...
    button_action_skip_back: {
      // generic on button with 'action=skip_backwards' as payload
      id: 'button_skip_back',
      prop: 'action',
    ...
    E1744_skip_step_size: {
        ...
        read: true,
        type: 'number',
        getter: payload => (payload.action === 'skip_backward' || (payload.action === 'skip_backward') ? payload.step_size : undefined,
    },
    E1744_skip_transition_time: {
        id: 'skip_transition_time',
        prop: 'action',
        name: 'Skip transition time',
        icon: undefined,
        role: 'value',
        write: false,
        read: true,
        type: 'number',
        getter: payload => (payload.action === 'skip_backward' || (payload.action === 'skip_backward') ? payload.transition_time : undefined,
    },
