...
//        type: 'number',
    ...
    ts0043_right_click: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'right_0') ? true : undefined,
        isEvent: true,
    },
    ts0043_middle_click: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_0') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_click: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'left_0') ? true : undefined,
        isEvent: true,
    },
    ts0043_right_double: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'right_1') ? true : undefined,
        isEvent: true,
    },
    ts0043_middle_double: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_1') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_double: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'left_1') ? true : undefined,
        isEvent: true,
    },
    ts0043_right_hold: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'right_2') ? true : undefined,
        isEvent: true,
    },
    ts0043_middle_hold: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'middle_2') ? true : undefined,
        isEvent: true,
    },
    ts0043_left_hold: {
        id: 'button_left_hold',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'left_2') ? true : undefined,
        isEvent: true,
    },        
    ts0041_click: {
        id: 'button_1_click',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === '0') ? true : undefined,
    },
    ts0041_double_click: {
        id: 'button_1_double',
        prop: 'action',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === '1') ? true : undefined,
    },
    ts0041_hold: {
        id: 'button_1_hold',
        prop: 'action',
        ...
        type: 'boolean',
        isEvent: true,
        getter: payload => (payload.action === '2') ? true : undefined,
    },            
/*    
    gira_pressed_up: {
        id: 'action',
