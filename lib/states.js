...
const states = {
   ...
   rob_1_click: {
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_1') ? true : ( payload.action === 'off_1' ) ? false : undefined,
        isEvent: true,
    },   
    rob_2_click: {
        id: 'button_2_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_2') ? true : ( payload.action === 'off_2' ) ? false : undefined,
        isEvent: true,
    },   
    rob_3_click: {
        id: 'button_3_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_3') ? true : ( payload.action === 'off_3' ) ? false : undefined,
        isEvent: true,
    },  
    rob_4_click: {
        id: 'button_4_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_4') ? true : ( payload.action === 'off_4' ) ? false : undefined,
        isEvent: true,
    },   
    rob_5_click: {
        id: 'button_5_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_5') ? true : ( payload.action === 'off_5' ) ? false : undefined,
        isEvent: true,
    },   
    rob_6_click: {
        id: 'button_6_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_6') ? true : ( payload.action === 'off_6' ) ? false : undefined,
        isEvent: true,
    },   
    rob_7_click: {
        id: 'button_7_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_7') ? true : ( payload.action === 'off_7' ) ? false : undefined,
        isEvent: true,
    },   
    rob_8_click: {
        id: 'button_8_click',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'on_8') ? true : ( payload.action === 'off_8' ) ? false : undefined,
        isEvent: true,
    },     
    hy_system_mode: {
        id: 'mode',
