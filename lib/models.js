...
const lightStatesWithColor=[states.color, states.hex_color],
    onOffStates=[states.state],
    lightStates = [states.state, states.brightness, states.brightness_move, states.transition_time, states.brightness_step],
    lightStatesWithColortemp = [...lightStates, states.colortemp, states.colortemp_move, states.color, states.hex_color],
    ...
    groupStates=[states.groupstateupdate, states.groupmemberupdate, ...lightStatesWithColortemp, ...onOffStates];
