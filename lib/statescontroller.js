...
class StatesController extends EventEmitter {
    ...
    updateDev(dev_id, dev_name, model, callback) {
        ...
        this.adapter.setObjectNotExists(id, {
            ...
            common: {name: __dev_name, type: model, icon: icon, statusStates: {onlineId: `${this.adapter.namespace}.${dev_id}.available`}},
            native: {id: dev_id}
        }, () => {
            // update type and icon
            this.adapter.extendObject(id, {common: {type: model, icon: icon, statusStates: {onlineId: `${this.adapter.namespace}.${dev_id}.available`}}}, callback);
        });
    }
