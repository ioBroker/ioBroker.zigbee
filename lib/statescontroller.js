    ...
    async processConverters(converters, devId, model, mappedModel, message, meta, debugId) {
        ...
        for (const converter of converters) {
            ...
            const payload = await new Promise((resolve, reject) => {
                ...
                this.emit('device_debug', {ID:debugId,data: { flag:`02.${cnt}x`, IO:true }, message:` data: ${safeJsonStringify(message.data)} meta:${JSON.stringify(meta)} result:${JSON.stringify(payloadConv)}`})
