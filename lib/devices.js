...
const devices = [
    ...
    },
    {
        ...
        states: [
		states.switch_state, states.switch_hold, states.switch_release,
		states.switch_circle, states.switch_circleclick, states.switch_circlehold,
		states.switch_down, states.switch_downhold,
		states.switch_up, states.switch_uphold,
		states.battery
		],
    },
    {
