...
const devices = [
    ...
    {
        vendor: 'Xiaomi',
        models: ['lumi.ctrl_ln2.aq1', 'lumi.ctrl_ln2'],
    ...
    */
    ...
    {
        vendor: 'OSRAM',
        models: ['PAR16 50 TW', 'MR16 TW OSRAM', 'PAR16 TW Z3'],
    ...
    {
        vendor: 'OSRAM',
        models: ['Surface Light TW', 'A60 TW Z3'],
    ...
    {
        vendor: 'OSRAM',
        models: ['Switch 4x EU-LIGHTIFY'],
        icon: 'img/ledvance_smartplus_switch.png',
        states: [states.left_top_click, states.right_top_click, states.left_bottom_click, states.right_bottom_click, states.left_top_hold, states.left_top_release, states.right_top_hold, states.right_top_release, states.left_bottom_hold, states.left_bottom_release, states.right_bottom_hold, states.right_bottom_release, states.battery, states.voltage],
    },
    {
        vendor: 'OSRAM',
    ...
    {
        vendor: 'IKEA',
        models: ['TRADFRI bulb E14 WS opal 400lm', 'TRADFRI bulb E12 WS opal 400lm', 'TRADFRI bulb E14 WS 470lm'],
    ...
    },
   {
    ...
    {
        vendor: 'Heiman',
        models: ['WarningDevice', 'WarningDevice-EF-3.0', 'SRHMP-I1'],
    ...
    {
        vendor: 'Smart Home Pty',
        models: ['FB56-ZCW11HG1.2', 'LXT56-LS27LX1.7'],
        icon: 'img/sylvania_rt.png',
        states: lightStatesWithColor,
        linkedStates: [comb.brightnessAndState],
    },
    {
        vendor: 'Smart Home Pty',
        models: ['FB56-ZCW11HG1.4','ZB-CT01'],
    ...
    {
        vendor: 'Nue / 3A',
        models: ['FB56+ZSW1GKJ2.5', 'LXN-1S27LX1.0', 'LXN56-0S27LX1.3'],
        icon: 'img/nue_switch_single.png',
        states: [states.state],
    },
    {
        vendor: 'Nue / 3A',
        models: ['FNB56-ZSW02LX2.0'],
