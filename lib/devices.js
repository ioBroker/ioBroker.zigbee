...
const lightStatesWithColortemp_tuya = [states.state, states.brightness, states.colortemp_tuya, states.transition_time];
const lightStatesWithColor = [states.state, states.brightness, states.colortemp, states.color, states.transition_time];
const lightStatesWithColor_tuya = [states.state, states.brightness, states.colortemp_tuya, states.color, states.transition_time];
const lightStatesWithColor_hue = [states.state, states.brightness, states.colortemp, states.color, states.transition_time, states.effect_type_hue];
...
**/
    ...
    },
    {
		...
		states: lightStatesWithColortemp_tuya,
		syncStates: [sync.brightness],
    },
    {
		models: ['14147206L'],
    ...
    },
    {
		...
		states: lightStatesWithColor_tuya, 
		syncStates: [sync.brightness],
    },
    {
		models: ['HG06104A'],
