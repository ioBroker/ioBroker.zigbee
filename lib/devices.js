...
const generator = {
    ...
    ptvo_switch: (entity) => {
        ...
        for (const endpoint of entity.device.endpoints) {
            ...
            const epName = getKey(entity.mapped.model.endpoint(entity.device), epID);
            ...
            if (endpoint.supportsOutputCluster('genMultistateInput')) {
                devstates.push({
                    ...
                    type: 'boolean',
                    isEvent: true,
                    getter: payload => (payload.click === `single_${epName}`) ? true : undefined,
                });
                devstates.push({
                    ...
                    type: 'boolean',
                    isEvent: true,
                    getter: payload => (payload.click === `double_${epName}`) ? true : undefined,
                });
                devstates.push({
                    ...
                    type: 'boolean',
                    isEvent: true,
                    getter: payload => (payload.click === `tripple_${epName}`) ? true : undefined,
                });
            }
        }
        return devstates;
...
const devices = [
    ...
    */
    ...
    },
    {
        ...
        states: [states.curtain_position, states.curtain_running, states.curtain_stop, states.curtain_reverse_direction],
    },
    {
        models: ['TS0121'],
        icon: 'img/lonsonho_plug.png',
