...
const lightStatesWithColortemp_mired = [states.state, states.brightness, states.colortemp_mired, states.transition_time];
const lightStatesWithColor = [states.state, states.brightness, states.colortemp, states.color, states.transition_time];
const lightStatesWithColor_mired = [states.state, states.brightness, states.colortemp_mired, states.color, states.transition_time];
