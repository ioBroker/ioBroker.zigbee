...
const devices = [
    ...
    */
    ...
    // Hue and Philips
    {
        ...
        states: [states.button_action_on,states.button_action_off,
    ...
    {
        vendor: 'Philips',
        models: ['LCT001', 'LCT007', 'LCT010', 'LCT012', 'LCT014', 'LCT015', 'LCT016', 'LCA001', 'LCF002'],
    ...
    },
    {
        ...
        states: [states.button_action_skip_forward, states.button_action_skip_forward,
          states.rotate_left, states.rotate_right,states.rotate_stop, states.battery, states.action_play_pause],
    },
    ...
    {
        vendor: 'Heiman',
        models: ['SMOK_V16',  'SMOK_YDLV10', 'SmokeSensor-EM', 'SmokeSensor-N', 'SmokeSendor-N-3.0',
